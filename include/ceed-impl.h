...
struct Ceed_private {
  ...
  int (*ElemRestrictionCreate)(CeedMemType, CeedCopyMode, const CeedInt *, const bool *, const char *, const char *, CeedElemRestriction);
  int (*ElemRestrictionCreateBlocked)(CeedMemType, CeedCopyMode, const CeedInt *, const bool *, const char *, const char *, CeedElemRestriction);
...
struct CeedElemRestriction_private {
  ...
  int (*GetCurlOrientations)(CeedElemRestriction, CeedMemType, const char **, const char **);
